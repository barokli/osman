<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fizik.aspx.cs" Inherits="fizik" %>
    ...
    <form  id="form1" runat="server" style="width:745px;">
        ...
        <div>
            <div class="empty-bg"  style="width: 745px; border: 1px solid red; float: left ">
                ...
                <br />
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" type="button" class="btn btn-primary" Text="İleri" style="width: 56px" />
